      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="glass rounded-2xl p-8 border border-white/10 hover:border-cyan-400/30 transition-all duration-300 h-full">
              {/* Top Section */}
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="glass rounded-xl p-5 border border-white/10 hover:border-cyan-400/30 transition-all duration-300"
              >
